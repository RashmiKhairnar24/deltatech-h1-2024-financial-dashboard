...
Download Portfolio_Khairnar_DeltaTech_Dashboard.xlsx.

Open it in Microsoft Excel or a compatible spreadsheet application.

Start with the dashboard sheet for the high-level view.

Use Analysis to see the supporting numbers.

Review Combined_Data when you want to trace the consolidated dataset.

Use the monthly sheets to inspect the original inputs.

Read Insights Recommendations for the business interpretation and proposed actions.
